...
public class ElectionsDemo {
	...
	Voter voter1 = new Voter("Precious", "Ghana", 'F', 17, 100001,"glory43");
	Voter voter2 = new Voter("Precious Njeck", "Ghana", 'F', 18, 100002,"yesteeo98");
	Voter voter3 = new Voter("Njeck Glory", "Ghana", 'F', 18, 100003,"67984");
	Voter voter4 = new Voter("Gideon Bonsu", "Ghana", 'M', 30, 100004,"ghnmwe1234");
	Voter voter5 = new Voter("Gabriel Owusu", "Ghana", 'M', 19, 100005,"000245hjy");
	Voter voter6 = new Voter("Owusu", "Ghana", 'M', 20, 100006,"rtyiey14");
	...
	Voter voter49 = new Voter("Analise Keating", "Ghana", 'F', 60, 100049,"55t55g");
	Voter voter50 = new Voter("Jon Snow", "Ghana", 'M', 32, 100050,"vfdd4r4");
	Voter voter51 = new Voter("Elizabeth Warren", "Ghana", 'F', 37, 100051,"gg67htgr");

	Candidate candidate1 = new Candidate(voter3.getName(), voter3.getNationality(), voter3.getGender(), voter3.getAge(), voter3.getVoterID(), "killer@2","CPDM");
	Candidate candidate2 = new Candidate(voter10.getName(), voter10.getNationality(), voter10.getGender(), voter10.getAge(), voter10.getVoterID(), "chairman06","CPDM");
	Candidate candidate3 = new Candidate(voter11.getName(), voter11.getNationality(), voter11.getGender(), voter11.getAge(), voter11.getVoterID(), "poirhtnb","NPP");
	Candidate candidate4 = new Candidate(voter12.getName(), voter12.getNationality(), voter12.getGender(), voter12.getAge(), voter12.getVoterID(),"rtinceq", "IPP");


	public static Pollingstation poll1 = new Pollingstation(11, "poll1", "Madina");
	public static Pollingstation poll2 = new Pollingstation(12, "poll2", "Kasoa");
	public static Pollingstation poll3 = new Pollingstation(13, "poll3", "Berekuso");
	public static Pollingstation poll4 = new Pollingstation(14, "poll4", "Adenta");
	public static Pollingstation poll5 = new Pollingstation(15, "poll5", "Dodowa");
	public static Pollingstation poll6 = new Pollingstation(16, "poll6", "Aburi");
	public static Pollingstation poll7 = new Pollingstation(17, "poll7", "Spintex");
	public static Pollingstation poll8 = new Pollingstation(18, "poll8", "Spanner");
	public static Pollingstation poll9 = new Pollingstation(19, "poll9", "Haatso");
	public static Pollingstation poll10 = new Pollingstation(20, "poll10", "Legon");
	public static Pollingstation poll11 = new Pollingstation(21, "poll11", "Bafut");
	public static Pollingstation poll12 = new Pollingstation(22, "poll12", "Mankon");
	public static Pollingstation poll13 = new Pollingstation(23, "poll13", "Ntarinkon");
	public static Pollingstation poll14 = new Pollingstation(24, "poll14", "Nkwen");
	public static Pollingstation poll15 = new Pollingstation(25, "poll15", "Roundabout1");
	public static Pollingstation poll16 = new Pollingstation(26, "poll16", "Mile10");
	public static Pollingstation poll17 = new Pollingstation(27, "poll17", "Musang");
	public static Pollingstation poll18 = new Pollingstation(28, "poll18", "Tiko");
	public static Pollingstation poll19 = new Pollingstation(29, "poll19", "Mutengene");
	public static Pollingstation poll20 = new Pollingstation(30, "poll20", "Biyem-Assi");

	public static Pollingstation[] stations = {poll1, poll2, poll3, poll4, poll5, poll6, poll7, poll8, poll9, poll10, poll11, poll12, poll13, poll14, poll15, poll16, poll17, poll18, poll19, poll20};


	public static DistrictOffice district1;
	public static DistrictOffice district2;
	public static DistrictOffice district3;
	public static DistrictOffice district4;
	public static DistrictOffice district5;
	public static DistrictOffice district6;
	public static DistrictOffice district7;
	public static DistrictOffice district8;
	public static DistrictOffice district9;
	public static DistrictOffice district10;

	public static ArrayList<DistrictOffice> reg1;
	public static ArrayList<DistrictOffice> reg2;
	public static ArrayList<DistrictOffice> reg3;
	public static ArrayList<DistrictOffice> reg4;

	public static RegionalOffice region1;
	public static RegionalOffice region2;
	public static RegionalOffice region3;
	public static RegionalOffice region4;

	public static ArrayList<RegionalOffice> nation = new ArrayList<RegionalOffice>();


	public static NationalOffice national;
	...
	public void test() {
		...
		district1 = new DistrictOffice(111, "district1", "Bamenda", dist1);
		district2 = new DistrictOffice(112, "district2", "Cape Coast", dist2);
		district2 = new DistrictOffice(112, "district2", "Cape Coast", dist2);
		district3 = new DistrictOffice(113, "district3", "Cantonments", dist3);
		district4 = new DistrictOffice(114, "district4", "Achimota", dist4);
		district5 = new DistrictOffice(115, "district5", "Kwabena", dist5);
		district6 = new DistrictOffice(116, "district6", "Lapaz", dist6);
		district7 = new DistrictOffice(117, "district7", "Batibo", dist7);
		district8 = new DistrictOffice(118, "district8", "Labadi", dist8);
		district9 = new DistrictOffice(119, "district9", "Kumasi", dist9);
		district10 = new DistrictOffice(120, "district10", "Buea", dist10);



		reg1 = new ArrayList<DistrictOffice>();
		reg1.add(district1);
		reg1.add(district2);
		reg1.add(district3);
		reg2 = new ArrayList<DistrictOffice>();
		reg2.add(district4);
		reg2.add(district5);
		reg3 = new ArrayList<DistrictOffice>();
		reg3.add(district6);
		reg3.add(district7);
		reg3.add(district8);
		reg4 = new ArrayList<DistrictOffice>();
		reg4.add(district9);
		reg4.add(district10);

		region1 = new RegionalOffice(1111, "region1", "NorthWest Region", reg1);
		region2 = new RegionalOffice(1112, "region2", "Central Region", reg2);
		region3 = new RegionalOffice(1113, "region3", "Eastern Region", reg3);
		region4 = new RegionalOffice(1114, "region4", "Southern Region", reg4);

		nation = new ArrayList<RegionalOffice>();
		nation.add(region1);
		nation.add(region2);
		nation.add(region3);
		nation.add(region4);

		national = new NationalOffice(12345, "Ghana", "Accra", nation);


	}

	public static void main(String[] args) {
		ElectionsDemo exec = new ElectionsDemo();
		exec.test();
